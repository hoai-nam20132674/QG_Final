...
class Categories extends Model
{
    ...
    public function addCategorie($request){
        ...
        $file->move('public/uploads/images/categories/share_image/',$file_name);
        $cate->share_image=$file_name;
        $avatar = Input::file('avatar');
        $ava_name = $avatar->getClientOriginalName();
        $avatar->move('public/uploads/images/categories/avatar/',$ava_name);
    ...
    public function editCategorie($request,$id){
        ...
        if(Input::hasFile('share_image')){ 
            ...
            $cate->share_image = $file_name;
            $request->file('share_image')->move('public/uploads/images/categories/share_image/',$file_name); 
        }
        if(Input::hasFile('avatar')){
            $ava_name = $request->file('avatar')->getClientOriginalName();
            $request->file('avatar')->move('public/uploads/images/categories/avatar/',$ava_name);
            $cate->avatar = $ava_name;
        }
        $cate->save();
    }
