						...
						@foreach($products_detail as $pr)
							...
							<tr>
								...
								<td class="text-center">
									...
									<a style="pointer-events: none;" href="{{URL::route('editProductDetail',$pr->id)}}" title="Sửa sản phẩm chi tiết"><i class="fa fa-pencil-square-o" style="width: 20%; font-size: 18px;"></i></a>
