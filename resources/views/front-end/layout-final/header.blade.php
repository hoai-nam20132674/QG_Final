		...
		<div id="masthead" class="header-main nav-dark">
      		<div class="header-inner flex-row container logo-left medium-logo-center" role="navigation">
          		<div id="logo" class="flex-col logo">
					<a href="/" title="Creeauto Vietnam" rel="home">
					    <img width="200" height="100" src="{{asset('uploads/images/systems/logo/'.$system->logo)}}" class="header_logo header-logo" alt="Creeauto Vietnam"/>
					    <img  width="200" height="100" src="{{asset('uploads/images/systems/logo/'.$system->logo)}}" class="header-logo-dark" alt="Creeauto Vietnam"/>
					</a>
          		</div>
